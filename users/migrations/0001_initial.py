    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contract_date', models.DateField(blank=True, null=True, verbose_name='Fecha contrato')),
                ('role', models.CharField(choices=[('A', 'Administrador'), ('P', 'Paseador'), ('D', 'Adiestrador')], default='P', max_length=1, verbose_name='Rol usuario')),
